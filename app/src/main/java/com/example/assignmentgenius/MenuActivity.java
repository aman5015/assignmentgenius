    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUploadAssignment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MenuActivity.this, UploadAssignmentActivity.class);
        ...
        btnManageAssignment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MenuActivity.this, ManageAssignmentActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnChatbox.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MenuActivity.this, ChatBoxActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnAssignmentDoer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MenuActivity.this, AssignmentDoerActivity.class);
                startActivity(intent);
            }
        });
